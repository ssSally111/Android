...
public class FailFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        TextView tvScore3 = getView().findViewById(R.id.tvScore3);
        tvScore3.setText("你的得分:"+score);

        Button btnReturn = getView().findViewById(R.id.btnReurn);
        btnReturn.setOnClickListener(v -> {
            NavController navController = Navigation.findNavController(v);
            navController.navigate(R.id.action_failFragment_to_titleFragment);
        });
    }
}
