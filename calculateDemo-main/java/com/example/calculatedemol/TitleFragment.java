...
public class TitleFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        TextView content = getView().findViewById(R.id.tvHighScore);
        content.setText("最高记录："+getActivity().getSharedPreferences("record", Context.MODE_PRIVATE).getInt("highScore", 0));

        Button btnEnter = getView().findViewById(R.id.btnEnter);
